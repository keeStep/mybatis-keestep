...
import org.kee.mybatis.reflection.invoker.SetFieldInvoker;
import org.kee.mybatis.reflection.property.PropertyNamer;
...
public class Reflector {
    ...
    private void addSetMethods(Class<?> clazz) {
        ...
        resolveSetterConflicts(conflictingGetters);
    }
    ...
    private void addSetMethod(String propName, Method method) {
        if (isValidPropertyName(propName)) {
            ...
            setTypes.put(propName, method.getReturnType());
        }
    }
